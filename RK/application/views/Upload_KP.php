    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SB Mahasiswa</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="<?php echo site_url('logmhs/uploadkp') ?>"><i class="fa fa-fw fa-bar-chart-o"></i> Upload KP</a>
                    </li>
                    <li>
                       <a href="<?php echo site_url('logmhs/uploadta') ?>"><i class="fa fa-fw fa-table"></i> Upload TA</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
